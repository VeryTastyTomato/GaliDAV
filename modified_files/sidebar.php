...
<div class = "calendar_list ui-widget block" id = "shared_calendar_list">
	<div class = "ui-widget-header ui-corner-all">
		<?php
			echo 'Matières partagées'// $this->i18n->_('labels', 'shared_calendars')
		?>
	</div>
	<div class = "ui-widget-content">
		<ul>
		...
		<div class = "buttons">
			<span id = "toggle_all_shared_calendars" class = "pseudobutton hide_all" title = "<?php echo $this->i18n->_('labels', 'toggleallcalendars') ?>"
			>
